package com.daviof.minhasfinancas.api.resource;
...
import com.daviof.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.daviof.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	public ResponseEntity buscar (
			...
			if (!usuario.isPresent()) {
				return ResponseEntity.badRequest().body("nao foi possilvel. usuario nao econtrado");
			} else {
	...
	public ResponseEntity deletar (@PathVariable("id") Long id) {
		...
		}).orElseGet( () -> new ResponseEntity("lancamento nao econtrado na base", HttpStatus.BAD_REQUEST));
	...
	private Lancamento converter (LancamentoDTO dto) {
		...
		Usuario usuario = usuarioService.obterPorId(dto.getUsuario())
				.orElseThrow(() -> new RegraNegocioException("Usuario nao econtradado para o ID"));
